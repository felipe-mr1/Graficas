...
class CelShadingPhongShaderProgram:
...
class CelShading4TonesPhongShaderProgram:
...
class CelShadingTexturePhongShaderProgram:
...
class CelShadingTexturePhongShaderProgram2:
        ...
        vertex_shader = """
            ...
            void main()
            {
                ...
                if(position.x>0 && position.y>0){
                    fragTexCoords = vec2((texture_index + 1)*1/3, 0); 
                }
                else if(position.x<0 && position.y>0){
                    fragTexCoords = vec2(texture_index*1/3, 0);
                }
                else if(position.x>0 && position.y<0){
                    fragTexCoords = vec2((texture_index + 1)*1/3, 1);
                }
                else{
                    fragTexCoords = vec2(texture_index*1/3, 1);
                }
                fragNormal = mat3(transpose(inverse(model))) * normal;  
