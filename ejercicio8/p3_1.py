...
if __name__ == "__main__":
    ...
    phongPipeline = nl.SimplePhongDirectionalShaderProgram()
    ...
    while not glfw.window_should_close(window):
        ...
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Ld"), 0.7, 0.7, 0.7)
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Ls"), 1.0, 1.0, 1.0)

        # Object is barely visible at only ambient. Diffuse behavior is slightly red. Sparkles are white
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Ka"), 0.7, 0.7, 0.7)
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Kd"), 0.7, 0.7, 0.7)
        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "Ks"), 1.0, 1.0, 1.0)

        glUniform3f(glGetUniformLocation(lightingPipeline.shaderProgram, "lightDirection"),  0, -1, -1)
        ...
        glUniform3f(glGetUniformLocation(phongTexPipeline.shaderProgram,  "lightDirection"), 0, -1, -1)
