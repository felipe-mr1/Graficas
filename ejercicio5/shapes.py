...
def createScene(pipeline):
    ...
    highwayNode.transform = tr.matmul([tr.translate(0, -0.65, 0), tr.scale(4, 0.4, 1)])
    ...
    backGroundNode.childs = [skyNode, mountainsNode, highwayNode, windMillGroupNode, lineNode] # sunNode pasa abajo
